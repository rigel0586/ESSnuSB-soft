/*
  ...
  .L simulate_7_graph_analyze.C
  simulate_7_graph_analyze()
              ...
              Int_t nStartEvent = 0, Int_t nEvents = 150)
{
  ...
  reconstruction::superfgd::FgdGraphStats* recon = new reconstruction::superfgd::FgdGraphStats(
    "Reconstruction Graph Analyzer"             // name of the task
